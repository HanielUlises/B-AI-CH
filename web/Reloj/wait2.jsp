...
function redireccionar(){
    window.location.href = "../Track ready/trackready.jsp?feeling=<%=feeling%>&gender=<%=genre%>&tempo=<%=tempo%>&nombreT=<%=nombreTrack%>";
}
...
byte[] ab=controla.generarCancion(feeling, tempo, genre, id, nombreTrack);
