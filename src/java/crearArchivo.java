...
public class crearArchivo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idS  = request.getParameter("id_Prompt");
        int id = Integer.parseInt(idS);
        byte[]archivoBytes=controlador.obtenerCancion(id);
        archivo.crearArchivoAudio(archivoBytes);
        response.sendRedirect("Track ready/gettrack.jsp");
    }
